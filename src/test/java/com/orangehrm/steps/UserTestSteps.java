...
public class UserTestSteps {
    ...
    public void iVerifySystemUsersText() {
        Assert.assertEquals("Not displayed:", "System Users", new ViewSystemUserPage().getSystemUserText());
    }
    ...
    public void iVerifyAddUserText() {
        Assert.assertEquals("Not Displayed:", "Add User", new ViewSystemUserPage().AddUser());
    }
    ...
    public void iEnterEmployeeNameAnanyaDash() throws InterruptedException {
        Thread.sleep(500);
        new ViewSystemUserPage().enterEmp();
    }

    @And("^I enter User name$")
    public void iEnterUserName() throws InterruptedException {
        Thread.sleep(500);
        new ViewSystemUserPage().enterUser();
    }
    ...
    public void iEnterPassword() {
        new ViewSystemUserPage().enterPass();
    }

    @And("^I enter Confirm Password$")
    public void iEnterConfirmPassword() {
        new ViewSystemUserPage().enterConfirmPass();
    }
    ...
    public void iSelectStatusEnable() throws InterruptedException {
        Thread.sleep(500);
        new ViewSystemUserPage().selectEnableOption();
    }
